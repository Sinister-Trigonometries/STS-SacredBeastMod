...
@SpireInitializer
public class SB_Mod implements
        EditCardsSubscriber,
        ...
        PostBattleSubscriber,PostDeathSubscriber
{
    ...
    public static final Logger logger = LogManager.getLogger(SB_Mod.class.getName());
    ...
    // Adding this color while leaving the other just in case
    public static final Color BEAST_WHITE = CardHelper.getColor(255.0f, 230.0f, 230.0f);
    ...
    private static final String ATTACK_DEFAULT_GRAY = "SacredBeastResources/images/512/bg_attack_default_gray.png";
    private static final String SKILL_DEFAULT_GRAY = "SacredBeastResources/images/512/bg_skill_default_gray.png";
    private static final String POWER_DEFAULT_GRAY = "SacredBeastResources/images/512/bg_power_default_gray.png";
    
    private static final String ENERGY_ORB_DEFAULT_GRAY = "SacredBeastResources/images/512/card_default_gray_orb.png";
    private static final String CARD_ENERGY_ORB = "SacredBeastResources/images/512/card_small_orb.png";
    
    private static final String ATTACK_DEFAULT_GRAY_PORTRAIT = "SacredBeastResources/images/1024/bg_attack_default_gray.png";
    private static final String SKILL_DEFAULT_GRAY_PORTRAIT = "SacredBeastResources/images/1024/bg_skill_default_gray.png";
    private static final String POWER_DEFAULT_GRAY_PORTRAIT = "SacredBeastResources/images/1024/bg_power_default_gray.png";
    private static final String ENERGY_ORB_DEFAULT_GRAY_PORTRAIT = "SacredBeastResources/images/1024/card_default_gray_orb.png";
    
    // Character assets
    private static final String THE_DEFAULT_BUTTON = "SacredBeastResources/images/charSelect/DefaultCharacterButton.png";
    private static final String THE_DEFAULT_PORTRAIT = "SacredBeastResources/images/charSelect/DefaultCharacterPortraitBG.png";
    public static final String THE_DEFAULT_SHOULDER_1 = "SacredBeastResources/images/char/defaultCharacter/shoulder.png";
    public static final String THE_DEFAULT_SHOULDER_2 = "SacredBeastResources/images/char/defaultCharacter/shoulder2.png";
    public static final String THE_DEFAULT_CORPSE = "SacredBeastResources/images/char/defaultCharacter/corpse.png";
    
    //Mod Badge - A small icon that appears in the mod settings menu next to your mod.
    public static final String BADGE_IMAGE = "SacredBeastResources/images/Badge.png";
    
    // Atlas and JSON files for the Animations
    public static final String THE_DEFAULT_SKELETON_ATLAS = "SacredBeastResources/images/char/defaultCharacter/skeleton.atlas";
    public static final String THE_DEFAULT_SKELETON_JSON = "SacredBeastResources/images/char/defaultCharacter/skeleton.json";
    ...
    public SB_Mod() {
      ...
      */
        ...
        logger.info("Creating the color " + COLOR_WHITE.toString());
        
        BaseMod.addColor(COLOR_WHITE, DEFAULT_GRAY, DEFAULT_GRAY, DEFAULT_GRAY, // TODO: come back to this later - what is going on with color?
    ...
    public static void setModID(String ID) { // DON'T EDIT
        ...
        InputStream in = SB_Mod.class.getResourceAsStream("/IDCheckStringsDONT-EDIT-AT-ALL.json"); // DON'T EDIT THIS ETHER
    ...
    private static void pathCheck() { // ALSO NO
        ...
        InputStream in = SB_Mod.class.getResourceAsStream("/IDCheckStringsDONT-EDIT-AT-ALL.json"); // DON'T EDIT THISSSSS
        IDCheckDontTouchPls EXCEPTION_STRINGS = coolG.fromJson(new InputStreamReader(in, StandardCharsets.UTF_8), IDCheckDontTouchPls.class); // NAH, NO EDIT
        String packageName = SB_Mod.class.getPackage().getName(); // STILL NO EDIT ZONE
    ...
    public static void initialize() {
        ...
        SB_Mod SacredBeastMod = new SB_Mod();
    ...
    public void receiveEditCharacters() {
        logger.info("Beginning to edit characters. " + "Add " + SB_Character.Enums.SACRED_BEAST.toString());
        
        BaseMod.addCharacter(new SB_Character("Sacred Beast", SB_Character.Enums.SACRED_BEAST),
                THE_DEFAULT_BUTTON, THE_DEFAULT_PORTRAIT, SB_Character.Enums.SACRED_BEAST);
        
        receiveEditPotions();
        logger.info("Added " + SB_Character.Enums.SACRED_BEAST.toString());
    }
    ...
    public void receivePostInitialize() {
        ...
        AddEventParams eventParams = new AddEventParams.Builder(IdentityCrisisEvent.ID, IdentityCrisisEvent.class) // for this specific event
            ...
            .playerClass(SB_Character.Enums.SACRED_BEAST) // Character specific event
            .create();
    ...
    public void receiveEditPotions() {
        ...
        BaseMod.addPotion(PlaceholderPotion.class, PLACEHOLDER_POTION_LIQUID, PLACEHOLDER_POTION_HYBRID, PLACEHOLDER_POTION_SPOTS, PlaceholderPotion.POTION_ID, SB_Character.Enums.SACRED_BEAST);
