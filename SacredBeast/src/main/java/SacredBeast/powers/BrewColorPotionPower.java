...
public class BrewColorPotionPower extends AbstractPower implements CloneablePowerInterface {
    ...
    private static BrewColorPotionAction.PotionColor color;

    public BrewColorPotionPower(final AbstractCreature owner, final AbstractCreature source, final BrewColorPotionAction.PotionColor color) {
        name = NAME;
        ID = POWER_ID;
